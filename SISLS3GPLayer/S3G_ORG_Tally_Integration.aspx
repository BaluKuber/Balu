            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <table width="100%" align="center" border="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="styleFieldAlign" width="30%">
                                                    <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" Width="55%" ToolTip="PO Status">
                                        ...
                                        <asp:GridView ID="gvPO" runat="server" AutoGenerateColumns="False" DataKeyNames="RowNumber" Width="100%" OnRowDataBound="gvPO_RowDataBound">
											...
											<asp:TemplateField HeaderText="SL.No." HeaderStyle-CssClass="styleGridHeader">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblTally_Integ_Hdr_ID" runat="server" Text='<%# Eval("Tally_Integ_Hdr_ID") %>' />
                                                    </ItemTemplate>
                ...
                <tr>
                    <td align="center">
                        ...
                        <asp:Button runat="server" ID="btnExport1" CssClass="styleSubmitButton" Text="Export"
                            OnClick="btnExport1_Click" ValidationGroup="Print" Enabled="false" />

                         <asp:Button runat="server" ID="btnSave" CssClass="styleSubmitButton" Text="Post to Tally"
