...
//Screen Name      :   S3GCLTCollateralMaster_View.aspx
//Created By       :   Anitha V
//Created Date     :   06-May-2011
//Purpose          :   To View Collateral Master Details
...
#endregion 
public partial class Collateral_S3GCLTCollateralMaster_View :ApplyThemeForProject
{
    #region Paging Config

    string strRedirectPage = "../Collateral/S3GCLTCollateralMaster_Add.aspx";
    int intNoofSearch = 1;
    string[] arrSortCol = new string[] { "Collateral_Ref_No", "LM.LOB_Code + '-' + LM.LOB_Name", "PM.Product_Code + ' - ' + PM.Product_Name", "CONM.Constitution_Name", "" };
    string strProcName = "S3G_CLT_GetCollateralMasterPaging";
