...
CodeFile="S3GLRTransLander.aspx.cs" Inherits="LegalRepossession_S3GLRTransLander" Title="Untitled Page" %>
            ...
            <td>
                <table width="100%" cellpadding="0" cellspacing="2px" border="0">                   
                    ...
                    <tr>
                         ...
                         <td class="styleFieldAlign">
                            <uc2:LOV ID="ucCustomerCodeLov" onblur="fnLoadCustomer()" runat="server" strLOV_Code="CMB"  DispalyContent="Code" />
