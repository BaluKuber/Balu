...
/// Purpose	            : To create garage entry
#endregion
...
public partial class LegalRepossession_S3GLRGarageMaster_View : ApplyThemeForProject
{
    #region Initialization
    //LegalAndRepossessionMgtServicesReference.LegalAndRepossessionMgtServicesClient ObjLegalMgtServicesClient;
    #endregion
    ...
    int intNoofSearch = 3;
    string[] arrSortCol = new string[] { "Garage_Code", "Garage_Owner_Code", "Garage_Name", "", "" };
    string strProcName = SPNames.S3G_LR_GetGarageDetails_Paging;
    ...
    protected void grvGarageMaster_RowCommand(object sender, GridViewCommandEventArgs e)
    {
