...
/// Created Date        :   23-Apr-2011
/// Purpose             :   This is the landing screen for all the other Legal repossession Screens
/// Last Updated By		:   
/// Last Updated Date   :   
/// Reason              :   
/// <Program Summary>
...
public partial class LegalRepossession_S3GLRTransLander : ApplyThemeForProject
{
    # region Programs Code
    string ProgramCodeToCompare = "";                                           // this is to hold the Program Code of your web page
    int PrgIDToCompare = 0;                                                     // This is to hold the Program ID based on which the Combos need to fill
    public string strQueryString = "";
    // Add here - Add your Program Code Here - refer to the SQL table Program Master.
    const string strRepossessionNotice = "GNO";
    const string strLegalHearingTrack = "GLHT";
    const string strRepossessionTrack = "GRT";
    const string strRepossessionNote = "GRN";
    const string strRepossessionRelease = "GRR";
    const string strSaleNotification = "GSN";   // Sale Notification  Created by Irsathameen on 29-Apr-2011
    const string strSaleBidEntry = "GSBE";// Sale Bid Entry Created by Srivatsan on 02-May-2011
    const string strSaleInvEntry = "GSIE";// Sale Invoice Entry  Created by Srivatsan on 05-May-2011
    const string strRepossession = "GRP";
    const string strGarageMaint = "GDM";
    ...
    string strProcName = "S3G_LR_TransLander";                             // this is the Stored procedure to get call                     
    ...
    public static LegalRepossession_S3GLRTransLander ojb_TransLander = null;
    string strLegalTrans_SP;
    ...
    private void FunPriTransactionActionButtons()
    {
        ...
        switch (ProgramCode)
        {
            case strRepossessionNotice:
                ...
                break;
            case strLegalHearingTrack:
                FunPriEnableActionButtons(true, true, true, false, false, false);
                break;
            case strRepossessionTrack:
                FunPriEnableActionButtons(true, true, true, false, false, false);
                break;
            case strRepossessionNote:
                FunPriEnableActionButtons(true, true, true, false, false, false);
                break;
            case strRepossessionRelease:
                FunPriEnableActionButtons(true, true, true, false, false, false);
                break;
            case strSaleNotification:
                FunPriEnableActionButtons(true, true, true, false, false, false);
                break;
            case strSaleBidEntry:
                FunPriEnableActionButtons(true, true, true, false, false, false);
                break;
            case strSaleInvEntry:
                FunPriEnableActionButtons(true, true, true, false, false, false);
                break;

            case strRepossession:
                FunPriEnableActionButtons(true, true, true, false, false, false);
                break;
    ...
    protected void InitPage()
    {
        ...
        switch (ProgramCode)
        {
            ...
            case strRepossessionNotice:
                ...
                PrgIDToCompare = 137;
                ProgramCodeToCompare = strRepossessionNotice;
                this.Title = "S3G - Repossession Notice";
                lblProgramIDSearch.Text = "Repossession Notice Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRRepossessionNotice.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetRepossessionNotice_AGT";
                break;
            ...
            case strLegalHearingTrack:
                ...
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 153;
                ProgramCodeToCompare = strLegalHearingTrack;
                this.Title = "S3G - Legal Hearing Track";
                lblProgramIDSearch.Text = "LHR Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRLegalHearingTrack.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetLHRNumber_AGT";
                break;
            case strRepossessionTrack:
                FunPubIsVisible(true, true, true);
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 136;
                ProgramCodeToCompare = strRepossessionTrack;
                this.Title = "S3G - Repossession Track";
                lblProgramIDSearch.Text = "Repossession Track Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRlRepossessionTrack.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetTrack_No_AGT";
                break;
            case strRepossessionNote:
                FunPubIsVisible(true, true, true);
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 152;
                ProgramCodeToCompare = strRepossessionNote;
                this.Title = "S3G - Repossession Note";
                lblProgramIDSearch.Text = "Repossession Note";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRRepossessionNote_Add.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetLegalRepossNote_AGT";
                break;
            case strRepossessionRelease:
                FunPubIsVisible(true, true, true);
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 151;
                ProgramCodeToCompare = strRepossessionRelease;
                this.Title = "S3G - Repossession Release";
                lblProgramIDSearch.Text = "Repossession Release Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRRepossessionReleaseAdd.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetRepoRelease_AGT";
                break;
            case strSaleNotification:    // Sale Notification 
                FunPubIsVisible(true, true, true);
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 149;
                ProgramCodeToCompare = strSaleNotification;
                this.Title = "S3G - Sale Notification";
                lblProgramIDSearch.Text = "Sale Notification Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRSaleNotification.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetSaleNotificationID_AGT";
                break;
            case strSaleBidEntry:    // Sale Bid Entry 
                FunPubIsVisible(true, true, true);
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 155;
                ProgramCodeToCompare = strSaleBidEntry;
                this.Title = "S3G - Sale Bid Entry";
                lblProgramIDSearch.Text = "Sale Bid Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRSaleBidEntry.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetSaleBidEntry_AGT";
                break;
            case strSaleInvEntry:   // Sale Invoice Entry 
                FunPubIsVisible(true, true, true);
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 156;
                ProgramCodeToCompare = strSaleInvEntry;
                this.Title = "S3G - Sale Invoice Entry";
                lblProgramIDSearch.Text = "Sale Invoice Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRSaleInvoiceEntry.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetSaleInvEntry_AGT";
                break;
            ...
            case strRepossession:
                ...
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 154;
                ProgramCodeToCompare = strRepossession;
                this.Title = "S3G - Repossession";
                lblProgramIDSearch.Text = "Repossession Docket Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLegalRepossessionRepossession_Add.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetRepossession_AGT";
                break;
            ...
            case strGarageMaint:
                ...
                FunPubIsMandatory(false, false, false, false);
                PrgIDToCompare = 245;
                ProgramCodeToCompare = strGarageMaint;
                this.Title = "S3G - Garage Maintanence";
                lblProgramIDSearch.Text = "Garage Docket Number";                                         // This is to display on the Document Number Label                
                strRedirectPage = "~/LegalRepossession/S3GLRGarage_Maint_Add.aspx";        // page to redirect to the page in edit mode
                strRedirectCreatePage = strRedirectPage + "?qsMode=C";        // page to redirect to the page in edit mode                
                lblHeading.Text = FunPubGetPageTitles(enumPageTitle.Details);
                strLegalTrans_SP = "S3G_LR_GetGarageMaintain_AGT";
                break;
    ...
    protected void FunProLoadCombos()
    {
        ...
        if (ProgramCode == strSaleNotification)
        {
            Procparam.Add("@Company_ID", Convert.ToString(intCompanyID));
            Procparam.Add("@User_ID", Convert.ToString(intUserID));
            Procparam.Add("@Is_Active", "1");
            if ((ProgramCode == strRepossessionNotice) || (ProgramCode == strRepossession) || (ProgramCode == strRepossessionTrack))
            {
                Procparam.Add("@FilterOption", "'FL','LN','HP','OL'");
            }
    ...
    private void FunPriLoadDNCCombo()
    {
        ...
        {
            case strRepossessionNote: 
                //FunPriLoadCombo_RepNoticeNumber();
                break;
            case strRepossessionNotice:                     // Repossession Notice
                //FunPriLoadCombo_RepNoticeNumber();
                break;
            case strLegalHearingTrack:                      //Legal Hearing Track
                //FunPriLoadCombo_LHRNumber();
                break;
            case strRepossessionTrack:                      // Repossession Notice               
                //FunPriLoadCombo_RepTrackNumber();
                break;
            case strSaleNotification:
                //FunPriLoadCombo_SaleNotificationNumbers();
                break;
            case strSaleBidEntry:
                //FunPriLoadCombo_SaleBidNo();
                break;
            case strSaleInvEntry:
                //FunPriLoadCombo_SaleInvNo();
                break;
            case strRepossession:                           //Repossession
                //FunPriLoadCombo_Repossession();
                break;
            case strGarageMaint:                           //Repossession
                //FunPriLoadCombo_GarageMaint();
                break;
            case strRepossessionRelease:                           //Repossession
    ...
    /// <summary>
    ///  Load the Document Number Combo Box with Repossession Track Number
    /// </summary>
    /// 

    private void FunPriLoadCombo_RepTrackNumber()
    {
        ...
        try
        {
            ...
            if (ComboBoxBranchSearch.SelectedValue != "0") Procparam.Add("@Location", Convert.ToString(ComboBoxBranchSearch.SelectedValue));

            //cmbDocumentNumberSearch.BindDataTable("S3G_LR_GetTrack_No", Procparam, true, "--Select--", new string[] { "ID", "Track_Number" });
        }
        catch (Exception ex)
        {
    ...
    /// <summary>
    ///  Load the Document Number Combo Box with Repossession Notice Number
    /// </summary>
    /// 

    private void FunPriLoadCombo_RepNoticeNumber()
    {
        //throw new NotImplementedException();
        try
        {
            ...
            //cmbDocumentNumberSearch.BindDataTable(SPNames.S3G_LR_GetRN_No, Procparam, true, "--Select--", new string[] { "ID", "Reposs_Number" });
        }
        catch (Exception ex)
        {
    ...
    /// <summary>
    ///  Load the Document Number Combo Box with LHR Number
    /// </summary>
    /// 
    private void FunPriLoadCombo_LHRNumber()
    {
        try
        {
            if (Procparam != null)
            ...
            if (!(string.IsNullOrEmpty(txtEndDateSearch.Text)))
                Procparam.Add("@EndDate", Utility.StringToDate(txtEndDateSearch.Text).ToString());
            //cmbDocumentNumberSearch.BindDataTable("S3G_LR_GetLHRNumbrt", Procparam, new string[] { "ID","LHR_No"});
           // cmbDocumentNumberSearch.BindDataTable("S3G_LR_GetLHRNumber", Procparam, true, "--Select--", new string[] { "ID", "LHR_No" });
    ...
    protected void grvTransLander_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)                // If data Row then check the data type and set the style - Alignment.
        {
            ...
            if (ProgramCode == strRepossession)
            {
                if (e.Row.Cells[10].Text == "Released" || e.Row.Cells[10].Text == "Sold")
                {
            ...
            if (ProgramCode == strRepossessionTrack)
            {
                if (e.Row.Cells[9].Text == "Released")
                {
                    imgbtnEdit.Enabled = false;
                    imgbtnEdit.CssClass = "styleGridEditDisabled";
                }
    ...
    public void FunPriLoadCombo_SaleBidNo()
    {
        if (ComboBoxLOBSearch.SelectedIndex > 0)
            Procparam.Add("@LOB_ID", Convert.ToString(ComboBoxLOBSearch.SelectedValue));
        if (ComboBoxBranchSearch.SelectedValue != "0")
        ...
        if (!(string.IsNullOrEmpty(txtEndDateSearch.Text)))
            Procparam.Add("@endDate", Utility.StringToDate(txtEndDateSearch.Text).ToString());
        Procparam.Add("@User_ID", Convert.ToString(intUserID));
        //cmbDocumentNumberSearch.BindDataTable(SPNames.S3G_LR_GetSaleBidID, Procparam, true, "--Select--", new string[] { "ID", "SBNO" });
    }
    public void FunPriLoadCombo_SaleInvNo()
    {
        if (ComboBoxLOBSearch.SelectedIndex > 0)
            Procparam.Add("@LOB_ID", Convert.ToString(ComboBoxLOBSearch.SelectedValue));
        if (ComboBoxBranchSearch.SelectedValue != "0")
        ...
        if (!(string.IsNullOrEmpty(txtEndDateSearch.Text)))
            Procparam.Add("@endDate", Utility.StringToDate(txtEndDateSearch.Text).ToString());
        Procparam.Add("@User_ID", Convert.ToString(intUserID));
        //cmbDocumentNumberSearch.BindDataTable(SPNames.S3G_LR_GetSaleInvoiceID, Procparam, true, "--Select--", new string[] { "ID", "SIENO" });
    }
    private void FunPriLoadCombo_Repossession()
    {
        if (Procparam != null)
            Procparam.Clear();
        Procparam.Add("@Company_ID", Convert.ToString(intCompanyID));
        ...
        if (!(string.IsNullOrEmpty(txtEndDateSearch.Text)))
            Procparam.Add("@EndDate", Utility.StringToDate(txtEndDateSearch.Text).ToString());
        //cmbDocumentNumberSearch.BindDataTable("S3G_LR_GetRepossessionNumber", Procparam, true, "-- Select --", new string[] { "ID", "Repossession_Docket_No" });
    }

    private void FunPriLoadCombo_GarageMaint()
    {
        if (Procparam != null)
            Procparam.Clear();
        Procparam.Add("@Company_ID", Convert.ToString(intCompanyID));
        ...
        if (!(string.IsNullOrEmpty(txtEndDateSearch.Text)))
            Procparam.Add("@EndDate", Utility.StringToDate(txtEndDateSearch.Text).ToString());
        //cmbDocumentNumberSearch.BindDataTable("S3G_LR_GetGarage_Number", Procparam, true, "-- Select --", new string[] { "ID", "GARAGEMAINTNO" });
    }
    [System.Web.Services.WebMethod]
    public static string[] GetBranchList(String prefixText, int count)
    {
        ...
        if (ojb_TransLander.ProgramCode == strRepossessionNotice)       //strRepossessionNotice = "GNO"; 
            Procparam.Add("@Program_ID", Convert.ToString(137));
        else if (ojb_TransLander.ProgramCode == strLegalHearingTrack)     //strLegalHearingTrack = "GLHT";   
            Procparam.Add("@Program_ID", Convert.ToString(153));
        else if (ojb_TransLander.ProgramCode == strRepossessionTrack)  //strRepossessionTrack = "GRT";
            Procparam.Add("@Program_ID", Convert.ToString(136));
        else if (ojb_TransLander.ProgramCode == strRepossessionNote)  //strRepossessionNote = "GRN";
            Procparam.Add("@Program_ID", Convert.ToString(152));
        else if (ojb_TransLander.ProgramCode == strRepossessionRelease) //strRepossessionRelease = "GRR";
            Procparam.Add("@Program_ID", Convert.ToString(151));
        else if (ojb_TransLander.ProgramCode == strSaleNotification) //strSaleNotification = "GSN"; 
            Procparam.Add("@Program_ID", Convert.ToString(149));
        else if (ojb_TransLander.ProgramCode == strSaleBidEntry) //strSaleBidEntry = "GSBE";
            Procparam.Add("@Program_ID", Convert.ToString(155));
        else if (ojb_TransLander.ProgramCode == strSaleInvEntry)  //strSaleInvEntry = "GSIE";
            Procparam.Add("@Program_ID", Convert.ToString(156));
        else if (ojb_TransLander.ProgramCode == strGarageMaint)   //strGarageMaint = "GDM";
            Procparam.Add("@Program_ID", Convert.ToString(245));
        else if (ojb_TransLander.ProgramCode == strRepossession)  //strRepossession = "GRP";
            Procparam.Add("@Program_ID", Convert.ToString(154));
    ...
    public static string[] GetDocumentNumber(String prefixText, int count)
    {
        ...
        suggetions = Utility.GetSuggestions(Utility.GetDefaultData(ojb_TransLander.strLegalTrans_SP, Procparam));
