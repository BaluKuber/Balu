<%@ Page Title="" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3G_FUNDMGT_FunderApproval_View.aspx.cs" Inherits="Fund_Management_S3G_FUNDMGT_FunderApproval_View" %>
                    ...
                    <td>
                        <asp:GridView ID="grvPaging" runat="server" AutoGenerateColumns="False" Width="100%" HeaderStyle-CssClass="styleGridHeader"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                            CommandArgument='<%# Bind("FunderApproval_ID") %>' CommandName="Query" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Modify" SortExpression="FunderApproval_ID" Visible="true"
                                    ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnEdit" ImageUrl="~/Images/spacer.gif" CssClass="styleGridEdit"
                                            AlternateText="Modify" CommandArgument='<%# Bind("FunderApproval_ID") %>' runat="server"
                                            CommandName="Modify" />
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="Funder Name">
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr align="center">
                                                <td>
                                                    <asp:LinkButton ID="lnkbtnSort2" runat="server" Text="Funder Name" ToolTip="Sort By Funder Name"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblFunderCode" runat="server" Text='<%# Bind("Funder_Name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Lessee Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFunderName" runat="server" Text='<%# Bind("Customer_Name") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr align="center">
                                                <td>
                                                    <asp:LinkButton ID="lnkbtnSort1" runat="server" Text="Lessee Name" ToolTip="Sort By Lessee Name"
                                                        CssClass="styleGridHeaderLinkBtn" OnClick="FunProSortingColumn"> </asp:LinkButton>
                                ...
                                <asp:TemplateField HeaderText="Funder Creation Date">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Approved Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lblApprovedDate" runat="server" Text='<%# Bind("Approved_Date") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <tr>
                    <td style="padding-top: 5px;" align="center">
                        <asp:Button ID="btnCreate" OnClick="btnCreate_Click" CausesValidation="false" CssClass="styleSubmitButton"
                            Text="Approve" runat="server" ToolTip="Approve Funder Details"></asp:Button>
                        <asp:Button ID="btnShowAll" runat="server" Text="Show All" CssClass="styleSubmitButton"
                            OnClick="btnShowAll_Click" ToolTip="Show All Approved Details" />
                    </td>
                </tr>
