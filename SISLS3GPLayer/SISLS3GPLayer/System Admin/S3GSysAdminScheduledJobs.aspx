<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="S3GSysAdminScheduledJobs.aspx.cs" Inherits="S3GSysAdminScheduledJobs" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="100%" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <asp:Panel ID="pnlScheduleDetails" Width="98%" GroupingText="Schedule Details" CssClass="stylePanel"
                            runat="server">
                            <table width="100%">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldAlign">
                                        ...
                                        <asp:RegularExpressionValidator ID="REVScheduleTime" runat="server" ValidationGroup="btnSave"
                                            ...
                                            Display="None" SetFocusOnError="True" ValidationExpression="^(20|21|22|23|[01]\d|\d)(([:][0-5]\d){1,2})$"></asp:RegularExpressionValidator>
