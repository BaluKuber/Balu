<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="S3GInsTranslander.aspx.cs" Inherits="S3GInsTranslander" Title="Untitled Page" %>
                    ...
                    <td>
                        <table width="100%" cellpadding="0" cellspacing="2px" border="0">
                            ...
                            <tr>
                                ...
                                <td class="styleFieldAlign">
                                    <uc2:Suggest ID="ComboBoxBranchSearch" runat="server" AutoPostBack="true" ServiceMethod="GetBranchList" />
                            ...
                            <tr>
                                ...
                                onkeyup="maxlengthfortxt(113)" DropDownStyle="DropDownList" MaxLength="0" CssClass="WindowsStyle">
                                    ...
                                    <uc2:Suggest ID="ucCustomer" Visible="false" AutoPostBack="true" runat="server" ServiceMethod="GetCustomerName" />
                                </td>
                            </tr>
                            <tr>
                                <td class="styleFieldLabel">
                                    <asp:Label Text="Tranche Name" Visible="false" runat="server" ID="lblTrancheName" CssClass="styleDisplayLabel" />
                                </td>
                                <td class="styleFieldAlign">
                                    <%-- <cc1:ComboBox ID="cmbDocumentNumberSearch" runat="server" AutoCompleteMode="SuggestAppend"
                                onkeyup="maxlengthfortxt(113)" DropDownStyle="DropDownList" MaxLength="0" CssClass="WindowsStyle">
                            </cc1:ComboBox>--%>
                                    <uc2:Suggest ID="ucTrancheName" Visible="false" AutoPostBack="true" runat="server" ServiceMethod="GetTrancheName" />
                                </td>
                                <td class="styleFieldLabel">
                                    <asp:Label Text="Rental Schedule No:" Visible="false" runat="server" ID="lblRSNo" CssClass="styleDisplayLabel" />
                                </td>
                                <td class="styleFieldAlign">
                                    <%-- <cc1:ComboBox ID="cmbDocumentNumberSearch" runat="server" AutoCompleteMode="SuggestAppend"
                                onkeyup="maxlengthfortxt(113)" DropDownStyle="DropDownList" MaxLength="0" CssClass="WindowsStyle">
                            </cc1:ComboBox>--%>
                                    <uc2:Suggest ID="ucRSNo" Visible="false" runat="server" ServiceMethod="GetPANUM" />
                                </td>
                            </tr>
                            <tr>
                                <td class="styleFieldLabel">
