...
public partial class UserControls_S3GGetRsNo: System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (strLOV_Code != null)
        {
            string strQuery = "window.open('../common/GetRSCustomer.aspx?LOV_Code=" + strLOV_Code + "&ControlID=" + strControlID + "&LOBID=" + strLOBID + "&RegionID=" + strRegionID + "&BranchID=" + strBranchID + "&ConstitutionID=" + strConstitutionID + "&DispCont=" + DispalyContent + "&Popup=Yes','newwindow','toolbar=no,location=no,menubar=no,width=650,height=330,resizable=no,scrollbars=yes,top=50,left=150'); return false; ";
    ...
    {
        string strQuery = "window.open('../common/GetRSCustomer.aspx?LOV_Code=" + LOVCode + "&ControlID=" + strControlID + "&LOBID=" + strLOBID + "&RegionID=" + strRegionID + "&BranchID=" + strBranchID + "&ConstitutionID=" + strConstitutionID + "&Popup=Yes','newwindow','toolbar=no,location=no,menubar=no,width=650,height=330,resizable=no,scrollbars=yes,top=50,left=150'); return false; ";
    ...
    protected void btnGetLOV_Click(object sender, EventArgs e)
    {
        if (hdnLovCode.Value != "")
        {
            ...
            if (strLOV_Code != null)
            {
                string strQuery = "window.open('../common/GetRSCustomer.aspx?LOV_Code=" + strLOV_Code + "&ControlID=" + strControlID + "&LOBID=" + strLOBID + "&RegionID=" + strRegionID + "&BranchID=" + strBranchID + "&ConstitutionID=" + strConstitutionID + "&Popup=Yes','newwindow','toolbar=no,location=no,menubar=no,width=650,height=330,resizable=yes,scrollbars=yes,top=50,left=150');";
               // string strQuery = "window.open('../common/GetRSCustomer.aspx?LOV_Code=" + strLOV_Code + "&Popup=Yes','newwindow','toolbar=no,location=no,menubar=no,width=870,height=330,resizable=yes,scrollbars=yes,top=0,left=0');";
                //string strQuery = "window.open('../common/GetRSCustomer.aspx?LOV_Code=" + strLOV_Code + "&ControlID=" + strControlID + "&LOBID=" + strLOBID + "&RegionID=" + strRegionID + "&BranchID=" + strBranchID + "&ConstitutionID=" + strConstitutionID + "&Popup=Yes','newwindow','toolbar=no,location=no,menubar=no,width=870,height=330,resizable=no,scrollbars=yes,top=50,left=150');"; 
                //string strQuery = "window.open('../common/GetRSCustomer.aspx?LOV_Code=RSCUST&Popup=Yes','newwindow','toolbar=no,location=no,menubar=no,width=500,height=330,resizable=no,scrollbars=yes,top=50,left=150');";
                //btnGetLOV.OnClientClick = strQuery;
