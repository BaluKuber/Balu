...
public partial class Common_GetRSCustomer : ApplyThemeForProject
{
    ...
    string[] arrSortCol = new string[3] { "Customer_Code", "Customer_Name", "Panum" };
    ...
    protected void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string strScripts = "popup('" + lbtAccName.Text + "','" + lbtAccName.CommandArgument + "','" + strControlId + "_txtName','" + strControlId + "_hdnID')";
    ...
    public void FunPubPageLoad()
    {
        try
        {
            ...
            {
                strBranchID = Convert.ToString(Request.QueryString["strBranchID"]);
            }
            if (Request.QueryString["LOV_Code"] != null && Request.QueryString["LOV_Code"] != string.Empty && Request.QueryString["LOV_Code"] != "")
            {
    ...
    private void FunPriBindGrid()
    {
        try
        {
            ...
            //gvList.BindICMGridView("S3G_CMN_GetLOV", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow, out arrSortCol); //By Siva.K
