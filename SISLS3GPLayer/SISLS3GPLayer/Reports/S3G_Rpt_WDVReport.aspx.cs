...
public partial class Reports_S3G_Rpt_WDVReport : ApplyThemeForProject
{
    ...
    public static Reports_S3G_Rpt_WDVReport obj_Page;
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            grvGST.BindGridView("S3G_RPT_GetWDVReport", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_GetWDVReport", Procparam);
            ...
            if (Grv.Rows.Count > 0)
            {
                string attachment = "attachment; filename=WDVReport.xls";
                ...
                row = dtHeader.NewRow();
                row["Column1"] = "WDV Report As On " + txtStartDate.Text;
                dtHeader.Rows.Add(row);
