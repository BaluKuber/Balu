<%@ Page Title="Form 17 Report" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3GRptForm17Report.aspx.cs" Inherits="Reports_S3GRptForm17Report" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table>
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="CHG-4 Report">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
            ...
            <table width="100%">
                        ...
                        <asp:Panel ID="pnlHeaderDetails" runat="server" GroupingText="Input Criteria" CssClass="stylePanel" Width="100%">
                            <table cellpadding="0" cellspacing="0" style="width: 100%" align="center">
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldAlign" width="30%">
                                        <asp:DropDownList ID="ddlStatus" runat="server" Width="60%" TabIndex="3">
                                ...
                                <tr>
                                    <td class="styleFieldLabel" width="20%">
                                        <asp:Label ID="lblStartDate" runat="server" Text="Closure Date From" CssClass="styleReqFieldLabel">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign" width="30%">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvStartDate" runat="server" ErrorMessage="Enter the Closure Date From" ValidationGroup="Go" CssClass="styleMandatoryLabel"
                                            Display="None" SetFocusOnError="True" ControlToValidate="txtStartDate"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="styleFieldLabel" width="20%">
                                        <asp:Label ID="lblEndDate" runat="server" Text="Closure Date To" CssClass="styleReqFieldLabel">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign" width="30%">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvEndDate" runat="server" ErrorMessage="Enter the Closure Date To" ValidationGroup="Go" Display="None" SetFocusOnError="True"
                ...
                <tr>
                    <td>
                        <asp:ValidationSummary ID="vsForm17Report" runat="server" CssClass="styleMandatoryLabel" CausesValidation="true" HeaderText="Correct the following validation(s):"
                ...
                <tr>
                    <td>
                        <asp:CustomValidator ID="CVForm17Report" runat="server" Display="None" ValidationGroup="btnPrint"></asp:CustomValidator>
                    </td>
