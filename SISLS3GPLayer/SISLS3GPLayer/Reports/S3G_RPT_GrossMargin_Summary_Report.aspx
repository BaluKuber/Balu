<%@ Page Title="" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3G_RPT_GrossMargin_Summary_Report.aspx.cs" Inherits="Reports_S3G_RPT_GrossMargin_Summary_Report" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Gross Margin Summary Report">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
            ...
            <table width="100%">
               ...
               <tr>
                    <td width="100%">
                        <asp:Panel ID="pnlVAT" runat="server" CssClass="stylePanel" GroupingText="Gross Margin Summary" Visible="false">
                            <asp:Label ID="lblError" runat="server" CssClass="styleDisplayLabel"></asp:Label>
                            <div id="myDivForPanelScroll" runat="server" style="overflow: scroll; width: 1100px">
