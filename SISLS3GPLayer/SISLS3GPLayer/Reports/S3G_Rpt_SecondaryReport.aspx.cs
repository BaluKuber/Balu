...
public partial class Reports_S3G_Rpt_SecondaryReport : ApplyThemeForProject
{
    ...
    public static Reports_S3G_Rpt_SecondaryReport obj_Page;
    ...
    private void CheckDate()
    {
        if (txtStartDate.Text != String.Empty && txtEndDate.Text != String.Empty)
        {
            ...
            {
                txtEndDate.Text = String.Empty;
                Utility.FunShowAlertMsg(this, "Rent End Date should be greater than or equal to Rent Start Date.");
                txtEndDate.Focus();
                return;
            }
        }
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            if (txtStartDate.Text == "" && txtEndDate.Text == "" && (ddlLesseeName.SelectedValue == "0" || ddlLesseeName.SelectedText == "") && ddlScheduleType.SelectedValue == "0")
            {
                Utility.FunShowAlertMsg(this, "Select the Rent Start Date and End Date");
                txtStartDate.Focus();
                return;
            }
            ...
            {
                Utility.FunShowAlertMsg(this, "Select the Rent End Date");
                txtEndDate.Focus();
                return;
            }
            ...
            if (txtStartDate.Text == "" && txtEndDate.Text != "")
            {
                Utility.FunShowAlertMsg(this, "Select the Rent Start Date");
                txtStartDate.Focus();
                return;
            }
            ...
            Procparam.Add("@ScheduleType", ddlScheduleType.SelectedValue);
            ...
            grvGST.BindGridView("S3G_RPT_GetSecondaryReport", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_GetSecondaryReport", Procparam);
            ...
            if (Grv.Rows.Count > 0)
            {
                string attachment = "attachment; filename=SecondaryReport.xls";
                ...
                row = dtHeader.NewRow();
                if (txtStartDate.Text != "")
                    row["Column1"] = "Secondary Report Between " + txtStartDate.Text + " and " + txtEndDate.Text;
                else
                    row["Column1"] = "Secondary Report";
                dtHeader.Rows.Add(row);
                ...
                if (ddlScheduleType.SelectedValue != "0")
                    row["Column2"] = "Type of Schedule: " + ddlScheduleType.SelectedItem.Text;
                else
                    row["Column2"] = "Type of Schedule: --All--";
