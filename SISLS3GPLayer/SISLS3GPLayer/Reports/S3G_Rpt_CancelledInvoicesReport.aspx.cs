...
public partial class Reports_S3G_Rpt_CancelledInvoicesReport : ApplyThemeForProject
{
    ...
    string strPageName = "Cancelled Invoices";
    DataTable dtTable = new DataTable();
    public static Reports_S3G_Rpt_CancelledInvoicesReport obj_Page;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            btnExport.Attributes.Add("onclick", "this.disabled = 'true';"
                                        + ClientScript.GetPostBackEventReference(btnExport, null)+
                                       ";this.src='/Images/Excel_excel_disabled.png';") ;
        ...
        {
            CVRepaymentSchedule.ErrorMessage = "Due to Data Problem, Unable to Load Cancelled Invoices";
    ...
    private void FunPriLoadPage()
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new ApplicationException("Unable to Load Cancelled Invoices page");
        }
    }
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            grvVAT.BindGridView("S3G_RPT_GetCancelledInvoicesReport", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_GetCancelledInvoicesReport", Procparam);
            ...
            if (Grv.Rows.Count > 0)
            {
                string attachment = "attachment; filename=Cancelled Invoices.xls";
                ...
                row = dtHeader.NewRow();
                row["Column1"] = "Cancelled Invoices Report between " + txtStartDate.Text + " to " + txtenddate.Text;
                dtHeader.Rows.Add(row);
