...
public partial class Reports_S3G_RPT_GrossMarginReport : ApplyThemeForProject
{
    ...
    public static Reports_S3G_RPT_GrossMarginReport obj_Page;
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            dsTable = Utility.GetDataset("S3G_RPT_GetGrossMarginReport", Procparam);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            */
            ...
            string filename = "Gross Margin Report_"+DateTime.Now.ToString() + ".xls";
            ...
            row = dtHeader.NewRow();
            row["Column1"] = "Gross Margin Report between " + txtStartDate.Text + " to " + txtenddate.Text;
            dtHeader.Rows.Add(row);
            ...
            if (ddlRSNo.SelectedValue == "0")
                row["Column2"] = "Tranche Name : --All--";
            else
                row["Column2"] = "Tranche Name : " + ddlTrancheNo.SelectedText;
            dtHeader.Rows.Add(row);
    ...
    protected void chkReportType_CheckedChanged(object sender, EventArgs e)
    {
        if(chkReportType.Checked)
            ddlRSNo.Enabled = false;
        else
            ddlRSNo.Enabled = true;
    }
}