...
public partial class Reports_S3GRptForm08Report : ApplyThemeForProject
{
    ...
    string strPageName = "Form 08 Report";
    public string strDateFormat;
    ReportAccountsMgtServicesClient objSerClient;
    public static Reports_S3GRptForm08Report obj_Page;
    ...
    private void FunPriLoadPage()
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                pnlForm08ReportDetails.Style.Add("display", "none");
            }
        }
        catch (Exception ex)
        {
    ...
    private void FunPriLoadStatus()
    {
        ...
        //    ddlStatus.BindMemoDataTable("S3G_RPT_GetAssetRgstrRptStatus", dictassetrgstr, new string[] { "LookUp_ID", "Name" });
        //}
        //catch (Exception ex)
        //{
        //}
    ...
    private void FunPriBindGrid()
    {
        ...
        try
        {
            ...
            pnlForm08ReportDetails.Style.Add("display", "block");
            grvForm08ReportDetails.Visible = true;
            grvForm08ReportDetails.BindGridView("S3G_RPT_GetForm08DetailsReport", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);

            //This is to hide first row if grid is empty
            if (bIsNewRow)
            {
                grvForm08ReportDetails.Rows[0].Visible = btnExport.Visible = false;
            }
            else
    ...
    private void CheckDate()
    {
        if (txtStartDate.Text != String.Empty && txtEndDate.Text != String.Empty)
        {
            ...
            if (intErrCount == -1)
            {
                ...
                Utility.FunShowAlertMsg(this, "Funder Receipt Date To Should Be Greater Than Funder Receipt Date From");
                txtEndDate.Focus();
                return;
            }
        }
    ...
    protected void btnClear_Click(Object sender, EventArgs e)
    {
        ...
        grvForm08ReportDetails.Visible = ucCustomPaging.Visible = btnExport.Visible = false;
        pnlForm08ReportDetails.Style.Add("display", "none");
    }
    ...
    protected void btnExport_Click(Object sender, EventArgs e)
    {
        try
        {
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_GetForm08DetailsReport", Procparam);
            ...
            if (Grv.Rows.Count > 0)
            {
                string attachment = "attachment; filename=CHG 1.xls";
                Response.ClearContent();
                Response.AddHeader("content-disposition", attachment);
                Response.ContentType = "application/vnd.xlsx";
                StringWriter sw = new StringWriter();
                ...
                row = dtHeader.NewRow();
                row["Column1"] = "CHG-1 Report for the period  of " + txtStartDate.Text + " to " + txtEndDate.Text;
                dtHeader.Rows.Add(row);               
    ...
    protected void grvForm08ReportDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
