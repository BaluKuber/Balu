...
public partial class Reports_S3GRptRepaymentSchedule : ApplyThemeForProject
{
    ...
    {
        ((Label)grvRepayDetails.FooterRow.FindControl("lblInstallmentAmount")).Text = TotalInstallmentAmount.ToString();
    ...
    protected void chkAmort_CheckedChanged(object sender, EventArgs e)
    {
