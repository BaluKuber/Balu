<%@ Page Title="Master PO Report" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3GRptMasterPOReport.aspx.cs" Inherits="Reports_S3GRptMasterPOReport" %>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table>
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Master PO Report">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
