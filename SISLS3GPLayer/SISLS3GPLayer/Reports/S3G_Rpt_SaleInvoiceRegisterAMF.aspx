<%@ Page Title="" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3G_Rpt_SaleInvoiceRegisterAMF.aspx.cs" Inherits="Reports_S3G_Rpt_SaleInvoiceRegisterAMF" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Sales Invoice Register AMF">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
            ...
            <table width="100%">
                            ...
                            <table align="center" width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblStartDate" runat="server" Text="Invoice Date From" CssClass="styleReqFieldLabel">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvStartDate" runat="server" ErrorMessage="Enter Invoice Date From" ValidationGroup="Go" CssClass="styleMandatoryLabel"
                                            Display="None" SetFocusOnError="True" ControlToValidate="txtStartDate"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblEnddate" runat="server" Text="Invoice Date To" CssClass="styleReqFieldLabel">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Invoice Date From" ValidationGroup="Go" CssClass="styleMandatoryLabel"
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblLocation" runat="server" Text="Location" CssClass="styleDisplayLabel" ToolTip="Location">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                ...
                <tr>
                    <td width="100%">
                        <asp:Panel ID="pnlVAT" runat="server" CssClass="stylePanel" GroupingText="Sale Invoice Register for AMF" Visible="false">
