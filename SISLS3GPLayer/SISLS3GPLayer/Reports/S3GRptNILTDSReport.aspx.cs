...
public partial class Reports_S3GRptNILTDSReport : ApplyThemeForProject
{
    ...
    public static Reports_S3GRptNILTDSReport obj_Page;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            FunPriLoadErrMsg("Due to Data Problem, Unable to Load PDC Summary Report.", objException);
        }
    }
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            grvPDC.BindGridView("S3G_RPT_GetNILTDSReport", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlLesseeName.SelectedValue == "0" && ddlLesseeName.SelectedText != "")
                ...
                Procparam.Add("@CustomerId", ddlLesseeName.SelectedValue.ToString());
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_GetNILTDSReport", Procparam);
            ...
            if (Grv.Rows.Count > 0)
            {
                string attachment = "attachment; filename=NILTDSReport.xls";
