...
public partial class Reports_S3G_Rpt_SaleInvoiceRegisterAMF : ApplyThemeForProject
{
    ...
    string strPageName = "Sale Invoice Register For AMF";
    DataTable dtTable = new DataTable();
    public static Reports_S3G_Rpt_SaleInvoiceRegisterAMF obj_Page;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            CVRepaymentSchedule.ErrorMessage = "Due to Data Problem, Unable to Load Sale Invoice Register For AMF";
    ...
    private void FunPriLoadPage()
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new ApplicationException("Unable to Load Sale Invoice Register For AMF page");
        }
    }
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            grvVAT.BindGridView("S3G_RPT_GetAMFReport", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ddlLocation.Clear();                // Test case AH_008 Senthilkumar P  10-Apr-2015
            ddlInvoiceNo.Clear();
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_GetAMFReport", Procparam);
            ...
            if (Grv.Rows.Count > 0)
            {
                string attachment = "attachment; filename=Sales Invoice Register For AMF.xls";
                ...
                row = dtHeader.NewRow();
                row["Column1"] = "Sales Invoice Register For AMF Report between " + txtStartDate.Text + " to " + txtenddate.Text;
                dtHeader.Rows.Add(row);
