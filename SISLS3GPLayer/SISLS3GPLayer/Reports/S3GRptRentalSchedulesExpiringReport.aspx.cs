...
public partial class Reports_S3GRptRentalSchedulesExpiringReport : ApplyThemeForProject
{
    ...
    string strPageName = "Rental Schedules Expiring Report";
    DataTable dtTable = new DataTable();
    public static Reports_S3GRptRentalSchedulesExpiringReport obj_Page;
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            grvRSExpired.BindGridView("S3G_RPT_GetRentalSchedulesExpiring", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        dtTable = Utility.GetDefaultData("S3G_RPT_GetRentalSchedulesExpiring", Procparam);
        ...
        if (Grv.Rows.Count > 0)
        {
            string attachment = "attachment; filename=RentalSchedulesExpiring.xls";
            ...
            row = dtHeader.NewRow();
            row["Column1"] = "Rental Schedules Expiring Report";
            dtHeader.Rows.Add(row);
            ...
            if (ddlLesseeName.SelectedText != "--All--" && ddlLesseeName.SelectedText != "")
            {
                row = dtHeader.NewRow();
            ...
            grv1.Rows[0].Cells[0].ColumnSpan = dtTable.Columns.Count;
            grv1.Rows[1].Cells[0].ColumnSpan = dtTable.Columns.Count;
            grv1.Rows[2].Cells[0].ColumnSpan = dtTable.Columns.Count;
            grv1.Rows[3].Cells[0].ColumnSpan = dtTable.Columns.Count;
