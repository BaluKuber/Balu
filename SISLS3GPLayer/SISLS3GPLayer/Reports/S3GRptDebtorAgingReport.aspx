<%@  Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3GRptDebtorAgingReport.aspx.cs" Inherits="Reports_S3GRptDebtorAgingReport" Title="Debtor Aging Report" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Debtor's Ageing Report">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
            ...
            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldAlign">
                                        <uc2:Suggest ID="ddlLesseeName" runat="server" ServiceMethod="GetLesseeNameDetails" 
                                            OnItem_Selected="ddlLesseeName_SelectedIndexChanged"
                                         AutoPostBack="true" WatermarkText="--All--" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblTranche" runat="server" Text="Tranche Name" CssClass="styleDisplayLabel">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        <asp:DropDownList ID="ddlTranche" runat="server" ToolTip="Tranche Name">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                ...
                <tr>
                    <td width="100%">
                        <asp:Panel ID="pnlPDC" runat="server" CssClass="stylePanel" GroupingText="Debtor's Ageing Report" Visible="false">
                            <asp:Label ID="lblError" runat="server" CssClass="styleDisplayLabel"></asp:Label>
                            <asp:GridView ID="grvPDC" runat="server" Width="100%" FooterStyle-HorizontalAlign="Center" OnRowDataBound="grvPDC_RowDataBound" HeaderStyle-CssClass="styleGridHeader">
                            </asp:GridView>
