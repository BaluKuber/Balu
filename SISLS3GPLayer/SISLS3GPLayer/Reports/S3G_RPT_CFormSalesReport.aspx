<%@ Page Language="C#" AutoEventWireup="true" CodeFile="S3G_RPT_CFormSalesReport.aspx.cs" MasterPageFile="~/Common/S3GMasterPageCollapse.master" Inherits="Reports_S3G_RPT_CFormSalesReport" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register TagPrefix="uc1" TagName="PageNavigator" Src="~/UserControls/PageNavigator.ascx" %>
<%@ Register TagPrefix="uc2" TagName="Suggest" Src="~/UserControls/S3GAutoSuggest.ascx" %>

<asp:Content ID="ContentCFormSalesReport" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="udpCFormSalesReport" runat="server">
        <ContentTemplate>
            <table width="100%" cellpadding="0" cellspacing="2px" border="0">
                <tr>
                    <td class="stylePageHeading">
                        <table>
                            <tr>
                                <td>
                                    <asp:Label ID="lblHeading" runat="server" EnableViewState="false" Text="C Form Sales Report" CssClass="styleInfoLabel">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td>
                        <asp:Panel ID="pnlCFormSalesReport" runat="server" GroupingText="Filter Criteria"
                            CssClass="stylePanel">
                            <table width="100%" cellpadding="0" cellspacing="2px" border="0">
                                <tr>
                                ...
                                <tr>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblPostingDateFrom" runat="server" Text="Activation From Date" CssClass="styleDisplayLabel" />
                                    </td>
                                    <td class="styleFieldAlign" style="width: 225px">
                                        <input id="hidActivationDate" type="hidden" runat="server" />
                                        <asp:TextBox ID="txtPostingDateFrom" runat="server" Width="140px" AutoPostBack="false" OnTextChanged="txtPostingDateFrom_TextChanged"></asp:TextBox>
                                    ...
                                    <td class="styleFieldLabel" style="width: 12%">
                                        <asp:Label ID="lblPostingDateTo" runat="server" Text="Activation To Date" CssClass="styleDisplayLabel" />
                                    </td>
                                    <td class="styleFieldAlign">
                                        <asp:TextBox ID="txtPostingDateTo" runat="server" Width="140px" AutoPostBack="false" OnTextChanged="txtPostingDateTo_TextChanged"></asp:TextBox>
                                ...
                                <tr>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblInvoiceDateFrom" runat="server" Text="Billing Invoice From Date" CssClass="styleDisplayLabel" />
                                    </td>
                                    <td class="styleFieldAlign" style="width: 225px">
                                        <input id="hidInvoiceDate" type="hidden" runat="server" />
                                        <asp:TextBox ID="txtInvoiceDateFrom" runat="server" Width="140px" AutoPostBack="false" OnTextChanged="txtInvoiceDateFrom_TextChanged"></asp:TextBox>
                                    ...
                                    <td class="styleFieldLabel" style="width: 12%">
                                        <asp:Label ID="lblInvoiceDateTo" runat="server" Text="Billing Invoice To Date" CssClass="styleDisplayLabel" />
                                    </td>
                                    <td class="styleFieldAlign">
                                        <asp:TextBox ID="txtInvoiceDateTo" runat="server" Width="140px" AutoPostBack="false" OnTextChanged="txtInvoiceDateTo_TextChanged"></asp:TextBox>
                                    ...
                                    <%--    <asp:CompareValidator ID="CVCFormInvoice" CssClass="styleMandatoryLabel" Display="None" 
                                            SetFocusOnError="True" runat="server" ControlToCompare="txtInvoiceDateFrom"
                                            ControlToValidate="txtInvoiceDateTo" ErrorMessage="Billing Invoice To date cannnot be lesser than Billing Invoice From date"
                                            ValidationGroup="Go" Operator="LessThan" Type="Date"></asp:CompareValidator>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%" colspan="4" align="center">&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldAlign" style="width: 225px">
                                        <uc2:Suggest ID="ddlStateName" runat="server" ValidationGroup="rfvSearch" WatermarkText="--All--" ServiceMethod="GetStateDetails"
                                    ...
                                    <td class="styleFieldAlign">
                                        <uc2:Suggest ID="ddlCustName" runat="server" WatermarkText="--All--" ServiceMethod="GetCustomerName"
                                            ErrorMessage="Enter Lessee Name" />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%" colspan="4" align="center">&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldAlign" style="width: 225px">
                                        <uc2:Suggest ID="ddlInvoiceNo" runat="server" ValidationGroup="rfvSearch" WatermarkText="--All--" IsMandatory="true" ServiceMethod="GetInvoiceNo"
                                    ...
                                    <td class="styleFieldAlign">
                                        <asp:DropDownList ID="ddlCForm" runat="server" Width="160px" AutoPostBack="true" OnSelectedIndexChanged="ddlCForm_SelectedIndexChanged">
                                            <asp:ListItem Value="0" Text="--All--" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="Received"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Not Received"></asp:ListItem>
                                        </asp:DropDownList>
                                     <%--   <asp:RequiredFieldValidator ID="rfvCForm" ValidationGroup="rfvSearch" InitialValue="0"
                                            CssClass="styleMandatoryLabel" runat="server" ControlToValidate="ddlCForm" ErrorMessage="Select C Form"
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldAlign" style="width: 225px">
                                        <uc2:Suggest ID="ddlCFormNumber" runat="server" WatermarkText="--All--" Enabled="false" ServiceMethod="GetCFormNo" />
                                    </td>
                                    <td class="styleFieldLabel" style="width: 12%">&nbsp;
                                    </td>
                                    <td class="styleFieldAlign">&nbsp;
                ...
                <tr>
                    <td width="100%" align="center">
                        <asp:Panel ID="PnlCFormDetails" runat="server" Visible="false" GroupingText="C Form Sales Details"
                            CssClass="stylePanel">
                            <%-- <div class="container" style="height: 100%; width: 100%; overflow-x: scroll; overflow-y: auto;">--%>
                            <asp:GridView ID="grvCFormSalesReport" runat="server" Width="100%" OnRowDataBound="grvCFormSalesReport_RowDataBound" EmptyDataText="No Record Found"
