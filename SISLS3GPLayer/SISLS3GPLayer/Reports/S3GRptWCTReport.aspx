<%@ Page Title="WCT Report" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3GRptWCTReport.aspx.cs" Inherits="Reports_S3GRptWCTReport" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table>
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="WCT Report">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        <asp:Panel ID="pnlWCTReportDetails" runat="server" CssClass="stylePanel" GroupingText="WCT Report Details" Width="100%">
                            <div id="myDivForPanelScroll" runat="server" style="overflow: scroll; width: 100%">
                                <asp:GridView ID="grvWCTReportDetails" runat="server" Width="100%" RowStyle-HorizontalAlign="Left" OnRowDataBound="grvWCTReportDetails_RowDataBound">                                  
                                </asp:GridView>
