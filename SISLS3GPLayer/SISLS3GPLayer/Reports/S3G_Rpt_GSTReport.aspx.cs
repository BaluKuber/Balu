...
public partial class Reports_S3G_Rpt_GSTReport : ApplyThemeForProject
{
    ...
    public static Reports_S3G_Rpt_GSTReport obj_Page;
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            grvGST.BindGridView("S3G_RPT_GetGSTReport", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_GetGSTReport", Procparam);
            ...
            if (Grv.Rows.Count > 0)
            {
                ...
                //row = dtHeader.NewRow();
                //row["Column1"] = "GST Report between " + txtStartDate.Text + " to " + txtenddate.Text;
                //dtHeader.Rows.Add(row);
