...
public partial class Reports_S3GRPTAssetCatwiseSalesVAT : ApplyThemeForProject
{
    ...
    int intUserId;
    int intErrCount = 0;
    int intProgramId = 326;
    string strPageName = "Asset Type wise VAT Rate Report";
    public string strDateFormat;
    ReportAccountsMgtServicesClient objSerClient;
    public static Reports_S3GRPTAssetCatwiseSalesVAT obj_Page;
    ...
    private void FunPriBindGrid()
    {
        ...
        try
        {
            ...
            grvVATReportDetails.BindGridView("S3G_RPT_Get_AssetCatWiseSalesRate", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void FunProExport(GridView Grv, string FileName)
    {
        try
        {
          ...
          dt = Utility.GetDefaultData("[S3G_RPT_Get_AssetCatWiseSalesRate]", Procparam);
          ...
          Grv.DataBind();
            if (Grv.Rows.Count > 0)
            {
                ...
                row = dtHeader.NewRow();
                row["Column1"] = "Asset Type Wise VAT Rate Report";
                dtHeader.Rows.Add(row);
    ...
    {
        FunProExport(grvVATReportDetails, "Asset Type Wise VAT Rate Report");
    }
    ...
    public static string[] GetAssettypeList(String prefixText, int count)
    {
        ...
        //Procparam.Add("@Parent_ID", obj_Page.ddlAssetCategory.SelectedValue.ToString());
