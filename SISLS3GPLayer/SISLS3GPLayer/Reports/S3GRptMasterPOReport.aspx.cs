...
public partial class Reports_S3GRptMasterPOReport : ApplyThemeForProject
{
    ...
    public static Reports_S3GRptMasterPOReport obj_Page;
    ...
    private void FunPriBindGrid(int IS_EXPORT)
    {
        ...
        try
        {
            ...
            grvPOReportDetails.BindGridView("S3G_RPT_Get_MPOReport_Paging_MPO", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnExport_Click(Object sender, EventArgs e)
    {
        try
        {
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_Get_MPOReport_Paging_MPO", Procparam);
