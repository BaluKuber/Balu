<%@ Page Title="" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3G_RPT_SalesInvoiceRental.aspx.cs" Inherits="Reports_S3G_RPT_SalesInvoiceRental" %>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Sales Invoice Register For Lease Rental">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
                            ...
                            <table align="center" width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblStartDate" runat="server" Text="Invoice Date From" CssClass="styleReqFieldLabel"></asp:Label>
                                    </td>
                                    ...
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblEnddate" runat="server" Text="Invoice Date To" CssClass="styleReqFieldLabel"></asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Invoice Date To" ValidationGroup="Go" CssClass="styleMandatoryLabel"
