<%@ Page Title="Pending WayBill Report" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="S3GRptPendingWBTReport.aspx.cs" Inherits="Reports_S3GRptPendingWBTReport" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table>
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Pending WayBill Report">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
            ...
            <table width="100%">
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 100%" align="center">
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldAlign" width="30%">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvEndDate" runat="server" ErrorMessage="Enter the End Date" ValidationGroup="Go" Display="None" SetFocusOnError="True"
                                            CssClass="styleMandatoryLabel" ControlToValidate="txtEndDate">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                    <td class="styleFieldLabel" width="20%"></td>
                ...
                <tr>
                    <td>
                        <asp:Panel ID="pnlPendingWBTReportDetails" runat="server" CssClass="stylePanel" GroupingText="Pending WayBill Report Details" Width="100%">
                            <div id="myDivForPanelScroll" runat="server" style="overflow: scroll; width: 100%">
                                <asp:GridView ID="grvPendingWBTReportDetails" runat="server" Width="100%" FooterStyle-HorizontalAlign="Right"
                ...
                <tr>
                    <td>
                        <asp:ValidationSummary ID="vsPendingWBTReport" runat="server" CssClass="styleMandatoryLabel" CausesValidation="true" HeaderText="Correct the following validation(s):"
                ...
                <tr>
                    <td>
                        <asp:CustomValidator ID="cvPendingWBTReport" runat="server" Display="None" ValidationGroup="btnPrint"></asp:CustomValidator>
                    </td>
                </tr>
                <tr>
