<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="S3G_RPT_DiscountedRepaymentReport.aspx.cs" Inherits="Reports_S3G_RPT_DiscountedRepaymentReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        ...
        <tr>
            <td class="styleFieldLabel" width="20%">
                <asp:Label runat="server" ID="lblSNum" Text="Sub Account" CssClass="styleDisplayLabel"
                    ToolTip="Sub Account"></asp:Label>
            </td>
            <td class="styleFieldAlign" align="left" width="30%">
                <asp:DropDownList ID="ddlSNum" runat="server" ToolTip="Sub Account">
                </asp:DropDownList>
