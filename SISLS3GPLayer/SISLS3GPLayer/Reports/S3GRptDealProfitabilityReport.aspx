<%@  Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3GRptDealProfitabilityReport.aspx.cs" Inherits="Reports_S3GRptDealProfitabilityReport" Title="Deal Profitability Report" %>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Deal Profitability Report">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td>
                        <asp:Panel ID="pnlCustomerInformation" runat="server" GroupingText="Input Criteria" CssClass="stylePanel" Width="100%">
                            <table align="center" width="100%" border="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblTranche" runat="server" Text="Tranche Name" CssClass="styleDisplayLabel" ToolTip="Tranche Name">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        <uc2:Suggest ID="ddlTranche" runat="server" ServiceMethod="GetTrancheNo" WatermarkText="--All--" />
                                    </td>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblAccountManager1" runat="server" Text="Account Manager1" CssClass="styleDisplayLabel" ToolTip="Account Manager1">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        <uc2:Suggest ID="ddlAccountManager1" runat="server" ServiceMethod="GetSalePersonList" WatermarkText="--All--" />
                                    </td>
                                </tr>

                                <tr>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblAccountManager2" runat="server" Text="Account Manager2" CssClass="styleDisplayLabel" ToolTip="Account Manager2">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        <uc2:Suggest ID="ddlAccountManager2" runat="server" ServiceMethod="GetSalePersonList" WatermarkText="--All--" />
                                    </td>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblRegionalManager" runat="server" Text="Regional Manager" CssClass="styleDisplayLabel" ToolTip="Regional Manager">
                                        </asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        <uc2:Suggest ID="ddlRegionalManager" runat="server" ServiceMethod="GetSalePersonList" WatermarkText="--All--" />
                                    </td>
                                </tr>
