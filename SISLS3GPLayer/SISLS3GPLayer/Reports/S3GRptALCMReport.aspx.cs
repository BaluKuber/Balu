...
public partial class Reports_S3GRptALCMReport : ApplyThemeForProject
{
    ...
    string strPageName = "ALCM Report";
    DataTable dtTable = new DataTable();
    public static Reports_S3GRptALCMReport obj_Page;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            CVRepaymentSchedule.ErrorMessage = "Due to Data Problem, Unable to Load ALCM Report.";
    ...
    private void FunPriLoadPage()
    {
        ...
        catch (Exception ex)
        {
              ...
              throw new ApplicationException("Unable to Load ALCM Report");
        }
    }
    ...
    private void FunPriLoadReport()
    {
        try
        {
            ...
            grvPDC.BindGridView("S3G_RPT_GetALCMReport", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dtTable = Utility.GetDefaultData("S3G_RPT_GetALCMReport", Procparam);
            ...
            if (Grv.Rows.Count > 0)
            {
                string attachment = "attachment; filename=ALCMReport.xls";
