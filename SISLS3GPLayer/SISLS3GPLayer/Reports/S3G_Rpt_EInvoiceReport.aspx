<%@ Page Title="" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3G_Rpt_EInvoiceReport.aspx.cs" Inherits="Reports_S3G_Rpt_EInvoiceReport" %>
                ...
                <tr>
                    <td class="stylePageHeading">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="E Invoice Report">
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
                        ...
                        <asp:Panel ID="pnlCustomerInformation" runat="server" GroupingText="Input Criteria" CssClass="stylePanel" Width="100%">
                            <table align="center" width="100%" border="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="styleFieldAlign">
                                        <uc2:Suggest ID="ddlLesseeName" Width="280px" runat="server" ServiceMethod="GetLesseeNameDetails"
                                            WatermarkText="--All--" />
                                    </td>
                                    <td class="styleFieldLabel">
                                ...
                                <tr>
                                    <td class="styleFieldLabel">
                                        <asp:Label ID="lblStatus" runat="server" Text="QR Code Status"></asp:Label>
                                    </td>
                                    <td class="styleFieldAlign">
                                        <asp:DropDownList ID="ddlStatus" runat="server" Width="170px">
                                            <asp:ListItem Value="0" Text="--All--" />
                                            <asp:ListItem Value="1" Text="Not Generated" />
                                            <asp:ListItem Value="2" Text="Generated" />
                                            <asp:ListItem Value="3" Text="Modification" />
                                            <asp:ListItem Value="4" Text="Cancelled" />
                                        </asp:DropDownList>
                                    </td>
                                    <td class="styleFieldLabel">
                                    ...
                                    <td class="styleFieldAlign">
                                        <asp:DropDownList ID="ddlInvoice" runat="server" Width="170px">
                                        </asp:DropDownList>
                                    </td>
                                    <%--<td class="styleFieldLabel">
