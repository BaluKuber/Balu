...
public partial class S3GORGPRDDCMaster_View : ApplyThemeForProject
{
    #region Paging Config

    string strRedirectPage = "~/Origination/S3GORGPRDDCMaster_Add.aspx";
    int intNoofSearch = 3;
    ...
    //string[] arrSortCol = new string[] { "LOB_Code + ' - ' + LOB_Name", "Product_Code+' - '+Product_Name", "Convert(Varchar,Constitution_Code)+' - '+Constitution_Name" };
    string strProcName = "S3G_ORG_GetPRDDC_Paging";
