<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="S3GORGPRDDCMaster_Add.aspx.cs" Inherits="S3GORGPRDDCMaster_Add" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <tr id="trConstitutionCode">
                                ...
                                <td class="styleFieldAlign">
                                    <asp:DropDownList ID="ddlLOB" Width="205px" OnSelectedIndexChanged="ddlLOB_OnSelectedIndexChanged"
                                        AutoPostBack="true" runat="server" onchange="ddl_itemchanged(this);">
                                    </asp:DropDownList>
                                </td>
                                <td colspan="2">
                            ...
                            <tr>
                                ...
                                <td class="styleFieldAlign">
                                    <asp:DropDownList ID="ddlProductCode" Width="205px" runat="server" AutoPostBack="True"
                                        OnSelectedIndexChanged="ddlProductCode_SelectedIndexChanged" onchange="ddl_itemchanged(this);">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
      ...
      ErrorMessage= "pls enter path in the format " ValidationExpression ="^(([a-zA-Z]:)|(([a-zA-Z]:)\\(([a-zA-Z]( ?)) *?([0-9]*?) *\\?)*?))$" ></asp:RegularExpressionValidator> --%>
                                ...
                                <tr>
                                    <td>
                                        <div style="overflow-x: hidden; overflow-y: auto; height: 112px; width: 750px">
                                            <asp:GridView runat="server" ID="grvPRDDC" Width="748px" OnRowDataBound="grvPRDDC_RowDataBound"
                ...
                <tr>
                    <td style="padding-top: 5px" align="center">
                        <div style="overflow-x: hidden; overflow-y: auto; width: 100%;" visible="false" id="divPRDDC"
                            runat="server">
                            <asp:GridView runat="server" ID="grvPRDDCDocuments" Width="100%" OnRowDataBound="grvPRDDCDocuments_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="PRDDC Type" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                                       >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPRDDCType" runat="server" Text='<%#Eval("PRDDCType")%>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddlPRDDCType" Width="270px" AutoPostBack="true" OnSelectedIndexChanged="ddlPRDDCType_OnSelectedIndexChanged"
                                                runat="server">
                                            </asp:DropDownList>
                ...
                <tr class="styleButtonArea" align="center" style="padding-left: 4px">
                    <td>
                        <br />
                        <asp:Button runat="server" ID="btnSave" OnClientClick="return fnCheckPageValidation('PRDDC');"
                            CssClass="styleSubmitButton" ValidationGroup="PRDDC" Text="Save" OnClick="btnSave_Click" />
                        <asp:Button runat="server" ID="btnClear" CausesValidation="false" CssClass="styleSubmitButton"
                            Text="Clear" ValidationGroup="PRDDC" OnClientClick="return fnConfirmClear();"
