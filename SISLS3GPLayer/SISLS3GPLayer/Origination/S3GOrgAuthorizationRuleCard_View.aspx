                                ...
                                <asp:TemplateField Visible="false">
                                    ...
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr align="center">
                                                <td>
                                                    <asp:LinkButton ID="lnkbtnSort2" CssClass="styleGridHeaderLinkBtn" runat="server" Visible="false"
                                                        OnClick="FunProSortingColumn" ToolTip="Sort By Product Name" Text="Product"></asp:LinkButton>
                                                    <asp:ImageButton ID="imgbtnSort2" CssClass="styleImageSortingAsc" runat="server" Visible="false"
                                                        ImageAlign="Middle" />
                                                </td>
                                            </tr>
                                            <tr align="left">
                                                <td>
                                                    <asp:TextBox AutoCompleteType="None" ID="txtHeaderSearch2" Visible="false" MaxLength="40" runat="server" Width="140px"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblProductName" runat="server" Visible="false" Text='<%# Bind("Product_Code") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderStyle CssClass="styleGridHeader"></HeaderStyle>
