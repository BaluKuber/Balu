<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="S3GORGROIRules_View.aspx.cs" Inherits="S3GORGROIRules_View" %>
                    ...
                    <td>
                        <asp:GridView ID="grvPaging" runat="server" Width="100%" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                            CommandArgument='<%# Bind("ROI_Rules_ID") %>' CommandName="Query" runat="server" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnEdit" runat="server" CssClass="styleGridEdit" ImageUrl="~/Images/spacer.gif"
                                            CommandArgument='<%# Bind("ROI_Rules_ID") %>' CommandName="Modify" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField SortExpression="Model_Description">
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr align="center">
                                                <td>
                                                    <asp:LinkButton ID="lnkbtnSort2" runat="server" CssClass="styleGridHeaderLinkBtn"
                                                        OnClick="FunProSortingColumn" ToolTip="Sort By Model Description" Text="Model Description"></asp:LinkButton>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblLOBName" runat="server" Text='<%# Bind("Model_Description") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="styleGridHeader"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="ROI_Rule_Number">
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr align="center">
                                                <td>
                                                    <asp:LinkButton ID="lnkbtnSort3" runat="server" CssClass="styleGridHeaderLinkBtn"
                                                        OnClick="FunProSortingColumn" ToolTip="Sort By ROI_Rule_Number" Text="ROI Rule Number"></asp:LinkButton>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblROIRulenumber" runat="server" Text='<%# Bind("ROI_Rule_Number") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="styleGridHeader"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
