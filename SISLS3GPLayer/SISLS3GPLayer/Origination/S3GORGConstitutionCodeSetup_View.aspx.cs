...
/// Screen Name     :   S3GORGConstitutionCodeSetup_View.aspx
/// Created By      :   Kaliraj K
/// Created Date    :   16-Jun-2010
/// Purpose         :   To view constitution master details
...
public partial class S3GORGConstitutionCodeSetup_View : ApplyThemeForProject
{
    #region Paging Config

    string strRedirectPage = "~/Origination/S3GORGConstitutionCodeSetup_Add.aspx";
    int intNoofSearch = 2;
    string[] arrSortCol = new string[] { "Constitution_Code", "Constitution_Name"};
    string strProcName = "S3G_ORG_GetConstitution_Paging";
    ...
    private void FunPriBindGrid()
    {
        try
        {
            ...
            Procparam.Add("@Constitution_ID", "0");
    ...
    {
        Response.Redirect(strRedirectPage + "?qsMode=C");
    }
