<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" Title="FIR Transaction"
    AutoEventWireup="true" CodeFile="S3GOrgFieldInformationReport_Add.aspx.cs" Inherits="Origination_S3GOrgFieldInformationReport" %>
                ...
                <tr width="100%">
                    <td align="center" width="10%">
                        ...
                        <asp:Button ID="btnCancel" runat="server" CausesValidation="False" CssClass="styleSubmitButton"
                            OnClick="btnCancel_Click" OnClientClick="return confirm('Do you want to cancel this record? Once you cancel you cannot revert it back.');"
