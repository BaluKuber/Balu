...
public partial class Origination_S3G_ORG_TechApp_Master_View : ApplyThemeForProject
{
    string strRedirectPage = "~/Origination/S3G_Org_TechApp_Master.aspx";
    int intNoofSearch = 3;
    ...
    //string[] arrSortCol = new string[] { "LOB_Code + ' - ' + LOB_Name", "Product_Code+' - '+Product_Name", "Convert(Varchar,Constitution_Code)+' - '+Constitution_Name" };
    string strProcName = "S3G_ORG_GetTechnical_Paging";
