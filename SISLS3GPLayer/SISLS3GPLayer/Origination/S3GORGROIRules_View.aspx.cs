...
public partial class S3GORGROIRules_View : ApplyThemeForProject
{
    #region Paging Config
    string strRedirectPage = "~/Origination/S3GORGROIRules_Add.aspx";
    int intNoofSearch;
    string[] arrSortCol = new string[] { "LOB_CODE + ' - ' +  LOB_NAME", "Model_Description", "ROI_Rule_Number" };
    string strProcName = "S3G_ORG_GetROIRules_Paging";
    ...
    private void FunPriBindGrid()
    {
        try
        {
            ...
            ObjPaging.ProProgram_ID = 27;
            FunPriGetSearchValue();

            Procparam = new Dictionary<string, string>();
            Procparam.Add("@ROI_Rules_ID", "-1");
    ...
    private string FunPriGetSortDirectionStr(string strColumn)
    {
        ...
        try
        {
            ...
            // string strSplitColumn = strColumn.Substring(0, strColumn.IndexOf("+"));
