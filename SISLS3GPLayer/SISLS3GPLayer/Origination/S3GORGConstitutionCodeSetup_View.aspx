<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master"
    AutoEventWireup="true" CodeFile="S3GORGConstitutionCodeSetup_View.aspx.cs" Inherits="S3GORGConstitutionCodeSetup_View" %>
                                            ...
                                            <tr align="center">
                                                <td>
                                                    <asp:LinkButton ID="lnkbtnSort2" CssClass="styleGridHeaderLinkBtn" runat="server"
                                                     OnClick="FunProSortingColumn" ToolTip="Sort By Constitution Name"
                                                        Text="Constitution Name"></asp:LinkButton>
