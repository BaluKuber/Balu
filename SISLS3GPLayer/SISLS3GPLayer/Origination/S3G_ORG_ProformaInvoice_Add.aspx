<%@ Page Language="C#" AutoEventWireup="true" CodeFile="S3G_ORG_ProformaInvoice_Add.aspx.cs"
    EnableEventValidation="false" Inherits="Origination_S3G_ORG_ProformaInvoice_Add"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                ...
                                <td width="50%" valign="top">
                                    <asp:Panel GroupingText="Purchase Order Details" ID="pnlCustomerInfo" runat="server" CssClass="stylePanel">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td class="styleFieldLabel">
                                                    <asp:Label ID="lblPINo" runat="server" Text="Proforma Invoice No" CssClass="styleDisplayLabel"></asp:Label>
                                                </td>
                                                <td class="styleFieldAlign">
                                                    <asp:TextBox ID="txtPINo" runat="server" ToolTip="Proforma Invoice No" MaxLength="50"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvPINo" ValidationGroup="Save" CssClass="styleMandatoryLabel"
                                                        ...
                                                        ErrorMessage="Enter a Proforma Invoice No" Display="None"></asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                <td class="styleFieldLabel">
                                                    <asp:Label ID="lblPIDate" runat="server" Text="Proforma Invoice Date" CssClass="styleDisplayLabel"></asp:Label>
                                                </td>
                                                <td class="styleFieldAlign">
                                                    <asp:TextBox ID="txtPIDate" runat="server" ToolTip="Proforma Invoice Date"></asp:TextBox>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RFVPIDate" ValidationGroup="Save" CssClass="styleMandatoryLabel"
                                                        ...
                                                        ErrorMessage="Enter a Proforma Invoice Date" Display="None"></asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                <td class="styleFieldLabel">
                                                    <asp:Label ID="lblPIStatus" runat="server" Text="Proforma Invoice Status" CssClass="styleDisplayLabel"></asp:Label>
                                                </td>
                                                <td class="styleFieldAlign">
                                                    <asp:TextBox ID="txtPIStatus" runat="server" ReadOnly="true" ToolTip="Proforma Invoice Status"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="SL.No." HeaderStyle-CssClass="styleGridHeader">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="lblPI_dtl_ID" runat="server" Text='<%# Eval("PI_det_ID") %>' Visible="false" />
                                                                        </ItemTemplate>
                                                                        <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Asset Category" HeaderStyle-CssClass="styleGridHeader">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="PI Quantity" HeaderStyle-CssClass="styleGridHeader">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPIQuantity" runat="server" Text='<%# Eval("PI_Quantity") %>'
                                                                                ToolTip="PI Quantity" />
                                                                        </ItemTemplate>
                                                                        <EditItemTemplate>
                                                                            <asp:TextBox ID="txtPIQuantity" runat="server" ToolTip="PI Quantity" Text='<%# Eval("PI_Quantity") %>'></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="rfvPIQuantity" SetFocusOnError="true" CssClass="styleMandatoryLabel"
                                                                                runat="server" ControlToValidate="txtPIQuantity" ErrorMessage="Enter the PI Quantity"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Currency Code" HeaderStyle-CssClass="styleGridHeader">
                                                                        ...
                                                                        <EditItemTemplate>
                                                                           <%-- <asp:DropDownList ID="ddlCurrencyCode" ValidationGroup="Footer" runat="server">
                                                                            </asp:DropDownList>--%>
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="rfvCurrencyCode" SetFocusOnError="true" CssClass="styleMandatoryLabel"
                                                                                runat="server" ControlToValidate="txtCurrencyCode" ErrorMessage="Ent the Currency Code"
                                                                                ValidationGroup="Footer" Display="None"></asp:RequiredFieldValidator>
                                                                        </EditItemTemplate>
                                                                        <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                ...
                <tr>
                    <td id="Td1" runat="server" align="center">
                        ...
                        <asp:Button runat="server" ID="btnDICancel" CssClass="styleSubmitButton" CausesValidation="False"
                            Text="Cancel PI" OnClick="btnDICancel_Click" ToolTip="Cancel PO" OnClientClick="return fnConfirmCancelDI()" />
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <script language="javascript" type="text/javascript">
        function fnConfirmCancelDI() {
            ...
            if (confirm('Do you want to cancel PI?')) {
                return true;
            }
            else
                return false;
        ...
        function fnConfirmSavePI() {
            ...
            if (confirm('Do you want to save PI?')) {
                return true;
            }
            else
                return false;
