<%@ Page Title="S3G - Pricing Approval" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master"
    AutoEventWireup="true" CodeFile="S3GORGPricingApproval_View.aspx.cs" Inherits="S3GORGPricingApproval_View" %>
                            ...
                            <tr>
                                <td class="stylePageHeading">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label runat="server" Text="Pricing Approval - Details" ID="lblHeading" CssClass="styleInfoLabel">
                                                </asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <asp:GridView ID="grvApprovalDetails" runat="server" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="styleGridHeader"
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton1" runat="server" CommandArgument='<%# Bind("Pricing_ID") %>'
                                            CssClass="styleGridQuery" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Business Offer Number" ItemStyle-HorizontalAlign="Center"
                                    HeaderStyle-CssClass="styleGridHeader" HeaderStyle-Width="25%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBusiness_Offer_Number" runat="server" Text='<%# Bind("Business_Offer_Number") %>'></asp:Label>
                                    </ItemTemplate>
