...
public partial class Origination_S3GOrgAuthorizationRuleCard_View : ApplyThemeForProject
{
   ...
   string[] arrSortCol = new string[] { "LOB_Code+ ' - ' + LOB_Name", "Product_Code+ ' - ' + Product_Name", "Convert(Varchar,Constitution_Code) +' - '+Constitution_Name", "Program_Code + ' - ' + Program_Name", "" };
