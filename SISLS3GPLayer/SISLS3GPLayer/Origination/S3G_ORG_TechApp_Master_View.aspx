<%@ Page Title="" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3G_ORG_TechApp_Master_View.aspx.cs" Inherits="Origination_S3G_ORG_TechApp_Master_View" %>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                            CommandArgument='<%# Bind("legal_id") %>' CommandName="Query" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" >
                                    ...
                                    <ItemTemplate>
                                       <asp:ImageButton ID="imgbtnEdit" CssClass="styleGridEdit" ImageUrl="~/Images/spacer.gif"
                                            CommandArgument='<%# Bind("legal_id") %>'  CommandName="Modify"
                                        runat="server" />
                                    </ItemTemplate>
