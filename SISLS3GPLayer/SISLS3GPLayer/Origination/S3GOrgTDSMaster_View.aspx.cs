...
public partial class Origination_S3GOrgTDSMaster_View : ApplyThemeForProject
{
   ...
   // OrgMasterMgtServicesReference.OrgMasterMgtServicesClient ObjOrgMasterMgtServicesClient;
    ...
    int intNoofSearch = 9;
    string[] arrSortCol = new string[] { "Name", "Tax_Code", "ConstitutionName", "Tax_Law_Section", "Tax_Description","PAN_Applicability","Effective_From","Threshold_Level","Tax" };
    string strProcName = "S3G_ORG_GetTDSDetails";
    ...
    protected void grvTDSMaster_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        FormsAuthenticationTicket Ticket = new FormsAuthenticationTicket(e.CommandArgument.ToString(), false, 0);
        switch (e.CommandName.ToLower())
        {
            case "modify":
                Response.Redirect(strRedirectPage + "?qsTDSId=" + FormsAuthentication.Encrypt(Ticket) + "&qsMode=M");
                break;
            case "query":
                Response.Redirect(strRedirectPage + "?qsTDSId=" + FormsAuthentication.Encrypt(Ticket) + "&qsMode=Q");
                break;
        }
    ...
    #endregion
    protected void grvTDSMaster_RowDataBound(object sender, GridViewRowEventArgs e)
    {
