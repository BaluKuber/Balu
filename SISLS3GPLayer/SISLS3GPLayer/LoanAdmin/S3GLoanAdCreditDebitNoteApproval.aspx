<%@ Page Language="C#" AutoEventWireup="true" Title="S3G - Debit Credit Note Approval"
    CodeFile="S3GLoanAdCreditDebitNoteApproval.aspx.cs" Inherits="S3GLoanAdManualJournalApproval_Add"
            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="top" class="stylePageHeading">
                        <asp:Label runat="server" Text="Debit Credit Note Approval" ID="lblHeading" CssClass="styleDisplayLabel">
                        </asp:Label>
                    </td>
                </tr>
                <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            &nbsp;<table width="100%" border="0">
                                                                ...
                                                                <tr>
                                                                    <td class="styleFieldLabel">
                                                                        <asp:Label ID="lblmjvNo" runat="server" Text="DCN Number" CssClass="styleReqFieldLabel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td class="styleFieldLabel">
                                                                        <asp:Label ID="lblDate" runat="server" Text="DCN Date"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td class="styleFieldLabel">
                                                                        <asp:Label ID="lblstatus" runat="server" Text="DCN Status"></asp:Label>
                                                                    </td>
                                                                    <td>
