<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="S3GLoanAdPDDCMaster_Add.aspx.cs" Inherits="S3GLoanAdPDDCMaster_Add" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      ...
      ErrorMessage= "pls enter path in the format " ValidationExpression ="^(([a-zA-Z]:)|(([a-zA-Z]:)\\(([a-zA-Z]( ?)) *?([0-9]*?) *\\?)*?))$" ></asp:RegularExpressionValidator> --%>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-Wrap="false"  FooterStyle-HorizontalAlign="Center">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:Button ID="addPDDC" runat="server" Text="Add" CssClass="styleGridShortButton"
                ...
                <tr class="styleButtonArea" align="center" style="padding-left: 4px">
                    <td>
                        <br />
                        <asp:Button runat="server" ID="btnSave" OnClientClick="return fnCheckPageValidation('PDDC');"
                        ...
                        <asp:Button runat="server" ID="btnCancel" Text="Cancel" ValidationGroup="PDDC" CausesValidation="false"
