<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master"
    AutoEventWireup="true" CodeFile="S3GLoanAdPDDCMaster_View.aspx.cs" Inherits="S3GLoanAdPDDCMaster_View" %>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                            CommandArgument='<%# Bind("PDDC_ID") %>' CommandName="Query" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" >
                                    ...
                                    <ItemTemplate>
                                       <asp:ImageButton ID="imgbtnEdit" CssClass="styleGridEdit" ImageUrl="~/Images/spacer.gif"
                                            CommandArgument='<%# Bind("PDDC_ID") %>'  CommandName="Modify"
                                        runat="server" />
                                    </ItemTemplate>
