...
public partial class S3GLoanAdPDDCMaster_View : ApplyThemeForProject
{
    #region Paging Config

    string strRedirectPage = "~/LoanAdmin/S3GLoanAdPDDCMaster_Add.aspx";
    int intNoofSearch = 3;
    ...
    //string[] arrSortCol = new string[] { "LOB_Code + ' - ' + LOB_Name", "Product_Code+' - '+Product_Name", "Convert(Varchar,Constitution_Code)+' - '+Constitution_Name" };
    string strProcName = "S3G_LOANAD_GetPDDC_Paging";
