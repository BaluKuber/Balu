<%@ Page Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="S3GLoanAdTLEWCTopup_Add.aspx.cs" Inherits="LoanAdmin_S3GLoanAdTLEWCTopup_Add" %>
                                        ...
                                        <asp:Panel GroupingText="Customer Information" ID="pnlCustomerInfo" runat="server"
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td class="styleFieldLabel" width="20%">
                                                        <asp:Label ID="lblDate" runat="server" Text="TE/WC Date" CssClass="styleReqFieldLabel"></asp:Label>
                                                    </td>
                                                    <td class="styleFieldAlign" width="25%">
                                                        <asp:TextBox ID="txtDate" runat="server" Width="200px" ToolTip="TE/WC Date"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="styleFieldLabel" width="20%">
                                                    ...
                                                    <td class="styleFieldAlign" width="25%">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rfvBranch" ValidationGroup="btnSave" runat="server"
                                                            Display="None" InitialValue="0" ErrorMessage="Select the Location" ControlToValidate="ddlBranch"
                                                            SetFocusOnError="True"></asp:RequiredFieldValidator>--%>
                                                    ...
                                                    <td class="styleFieldLabel" width="10%">
                                                        <asp:Label ID="lblTLENo" runat="server" Text="TE/WC Number" CssClass="styleReqFieldLabel"></asp:Label>
                                                    </td>
                                                    <td class="styleFieldAlign" width="25%">
                                                        <asp:TextBox ID="txtTLEWC" runat="server" Width="200px" ReadOnly="True" ToolTip="TE/WC Number"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="styleFieldLabel" width="20%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="styleFieldAlign" width="25%">
                                                        ...
                                                        <%--     <asp:RequiredFieldValidator ID="rfvSanctionedAmount" ValidationGroup="btnSave" runat="server"
                                                            Display="None" ErrorMessage="Enter the Sanctioned Amount" ControlToValidate="txtSanctionedAmount"
                                                            SetFocusOnError="True"></asp:RequiredFieldValidator>--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="styleFieldAlign" width="25%">
                                                        <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Wrap="true" Width="200px"
                ...
                <tr>
                    <td align="center">
                        <div style="margin-top: 10px;">
                            ...
                            <cc1:ConfirmButtonExtender ID="cbeCancelTopup" runat="server" ConfirmText="Do you want to Cancel the Topup?"
