...
namespace S3GDALayer
{
    namespace S3GAdminServices
    {
        public class ClsPubS3GAdmin
        {
            ...
            public DataTable FunPubFillDropdown_Report(string strProcName, Dictionary<string, string> dctProcParams)
            {
            ...
            public int FunPubValidateLogin(string strUserLoginCode, out string strPassword, out int intCompanyID, 
                out int intUserID, out int intUser_Level_ID,out int loginDiff,out string strUserName, out string strCompanyName, 
                out string strCompanyCode, out DateTime LastLoginDate, out string strTheme, out string strAccess,
                out string strCountryName, out string strUserType, out string strMarquee, int SSOEnabled)
            {
                intCompanyID = 0;
                intUserID = 0;
                intUser_Level_ID = 0;
                ...
                try
                {
                    ...
                    db.AddOutParameter(command, "@loginDiff", DbType.Int32, sizeof(Int32));
                    ...
                    loginDiff = (command.Parameters["@loginDiff"].Value != DBNull.Value) ? (int)command.Parameters["@loginDiff"].Value : 0;
                }
            ...
            public int FunPubForgetPassword(string strUserLoginCode, string strNewPassword, int intCompanyID, 
                out string strUserName, out string strUserMailID)
            {
                try
                {
                    DbCommand command = db.GetStoredProcCommand("S3G_Sysad_ForgetPassword");
                    db.AddInParameter(command, "@UserLoginID", DbType.String, strUserLoginCode);
                    db.AddInParameter(command, "@NewPassword", DbType.String, strNewPassword);
                    db.AddInParameter(command, "@CompanyID", DbType.Int32, intCompanyID);
                    db.AddOutParameter(command, "@UserName", DbType.String, 100);
                    db.AddOutParameter(command, "@User_MailID", DbType.String, 100);
                    db.AddOutParameter(command, "@ErrorCode", DbType.Int32, sizeof(Int32));

                    db.FunPubExecuteNonQuery(command);
                    intErrorCode = (command.Parameters["@ErrorCode"].Value != DBNull.Value) ? (int)command.Parameters["@ErrorCode"].Value : 0;
                    strUserMailID = Convert.ToString((command.Parameters["@User_MailID"].Value != DBNull.Value) ? command.Parameters["@User_MailID"].Value : string.Empty);
                    strUserName = Convert.ToString((command.Parameters["@UserName"].Value != DBNull.Value) ? command.Parameters["@UserName"].Value : 0);
            ...
            public int FunPubUpdateLocationCategory(SerializationMode SerMode, byte[] bytesLocation_Datatable)
            {
                ...
                try
                {
                    ...
                    db.AddInParameter(command, "@VATTIN", DbType.String, ObjS3g_Location_Category_Row.VATTIN);
                    db.AddInParameter(command, "@CSTTIN", DbType.String, ObjS3g_Location_Category_Row.CSTTIN);
                    db.AddInParameter(command, "@WCT", DbType.String, ObjS3g_Location_Category_Row.WCT);
                    if (!ObjS3g_Location_Category_Row.IsVATDATENull())
                        db.AddInParameter(command, "@VATDATE", DbType.DateTime, ObjS3g_Location_Category_Row.VATDATE);
                    if (!ObjS3g_Location_Category_Row.IsCSTDATENull())
                        db.AddInParameter(command, "@CSTDATE", DbType.DateTime, ObjS3g_Location_Category_Row.CSTDATE);
                    if (!ObjS3g_Location_Category_Row.IsWCTDATENull())
                        db.AddInParameter(command, "@WCTDATE", DbType.DateTime, ObjS3g_Location_Category_Row.WCTDATE);
                    db.AddInParameter(command, "@SGSTIN", DbType.String, ObjS3g_Location_Category_Row.SGSTIN);
                    if (!ObjS3g_Location_Category_Row.IsSGST_Reg_DateNull())
                        db.AddInParameter(command, "@SGST_Reg_Date", DbType.DateTime, ObjS3g_Location_Category_Row.SGST_Reg_Date);

                    db.AddInParameter(command, "@GST_State_Code", DbType.String, ObjS3g_Location_Category_Row.GST_State_Code);

                    db.AddOutParameter(command, "@ErrorCode", DbType.Int32, sizeof(Int32));

                    db.AddInParameter(command, "@XMLAddressDetails", DbType.String, ObjS3g_Location_Category_Row.XMLAddressDetails);

                    if (!ObjS3g_Location_Category_Row.IsEffective_FromNull())
                        db.AddInParameter(command, "@Effective_From", DbType.DateTime, ObjS3g_Location_Category_Row.Effective_From);
