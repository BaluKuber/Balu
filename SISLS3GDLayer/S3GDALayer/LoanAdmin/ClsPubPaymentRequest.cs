        ...
        public class ClsPubPaymentRequest
        {
            ...
            public int FunPubCreateOrModifyPaymentRequest(SerializationMode SerMode, byte[] bytesObjPaymentRequest_DataTable, out string paynum, out int request_No)
            {
                ...
                try
                {
                    ...
                    {
                        DbCommand command = db.GetStoredProcCommand("S3G_LOANAD_InsertPaymentRequest");
                        ...
                        if (ObjPaymentRequestRow.Vendor_Code != -1)
                            db.AddInParameter(command, "@Vendor_Code", DbType.Int64, ObjPaymentRequestRow.Vendor_Code);
                        if (ObjPaymentRequestRow.Customer_ID != -1)
                            db.AddInParameter(command, "@Customer_Code", DbType.Int64, ObjPaymentRequestRow.Customer_ID);
                        ...
                        if (!ObjPaymentRequestRow.IsXML_PaymentDetailsNull())
                        {
                        ...
                        if (!ObjPaymentRequestRow.IsXML_FunderPmtDtlNull())
                            db.AddInParameter(command, "@XML_FunderPmtDtl", DbType.String, ObjPaymentRequestRow.XML_FunderPmtDtl);
                        ...
                        if (!(string.IsNullOrEmpty(ObjPaymentRequestRow.Remarks)))
                            db.AddInParameter(command, "@Remarks", DbType.String, ObjPaymentRequestRow.Remarks);
                        db.AddInParameter(command, "@PaymentGateWayRefNo", DbType.String, ObjPaymentRequestRow.PaymentGateWayRefNo);
                        ...
                        if (ObjPaymentRequestRow.Requestno != -1)
                            db.AddInParameter(command, "@Requestno", DbType.Int64, ObjPaymentRequestRow.Requestno);

                        if (!ObjPaymentRequestRow.IsXML_POInvoiceDtlsNull())
                        {
                            db.AddInParameter(command, "@XML_POInvoiceDtl", DbType.String, ObjPaymentRequestRow.XML_POInvoiceDtls);
                        }
                        db.AddInParameter(command, "@Payment_From", DbType.Int64, ObjPaymentRequestRow.Payment_From);
                        db.AddInParameter(command, "@Tranche_ID", DbType.Int64, ObjPaymentRequestRow.Tranche_ID);
                        if (!ObjPaymentRequestRow.IsFunder_IDNull())
                            db.AddInParameter(command, "@Funder_ID", DbType.Int64, ObjPaymentRequestRow.Funder_ID);
                        db.AddInParameter(command, "@Payee_Bank_ID", DbType.Int32, ObjPaymentRequestRow.Payee_Bank_ID);
                        db.AddInParameter(command, "@Favouring_Name", DbType.String, ObjPaymentRequestRow.Favouring_Name);
