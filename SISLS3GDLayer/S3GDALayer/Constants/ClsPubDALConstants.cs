...
namespace S3GDALayer.Constants
{
    public class ClsPubDALConstants
    {
        ...
        public const string DueFlags = "Due_Flag";

        public const string PO_Number = "PO_Number";

        public const string PO_Date = "PO_Date";

        public const string PI_Number = "PI_Number";

        public const string PI_Date = "PI_Date";

        public const string VI_Number = "VI_Number";

        public const string VI_Date = "VI_Date";
        ...
        public const string Asset_Sub_Type = "Asset_Sub_Type";

        public const string Total_SCH_Amt = "Total_SCH_Amt";

        public const string INVOICE_AMOUNT = "INVOICE_AMOUNT";

        public const string CAPITALISEDAMOUNT = "CAPITALISEDAMOUNT";
