...
namespace S3GDALayer.Collateral
{
    ...
    {
        public class ClsPubCollateralCapture : ClsPubDalCollateralBase
        {
            ...
            public int FunPubCreateCollateralCapture(SerializationMode SerMode, byte[] bytesObjCollateralCaptureDataTable, out string StrCollCap_No)
            {
                ...
                try
                {
                    ...
                    if (!ObjCollateralCaptureRow.IsCustomer_IDNull())
                    {
