...
namespace S3GBusEntity
{
    ...
    public class CustomerMasterBusEntity
    {
        ...
        public string Perm_TIN { get; set; }
        public string Perm_TAN { get; set; }
        ...
        public string XMLBillingDetails { get; set; }
        ...
        public bool IS_HotListed { get; set; }
        public bool IS_POBlack { get; set; }
        public string HotList_Reason { get; set; }
        public string Customer_Rating { get; set; }
        public string IFSC_Code { get; set; }
        public string Rental_ScheduleNo { get; set; }
        public string Tranche_No { get; set; }
        //End 
        ...
        //Added on 26Sep2014 ends here   

        public string XmlPODOMappings { get; set; }
        public string XmlPODOMappingsDetails { get; set; }

        public string CGSTIN { get; set; }
        public DateTime CGST_Reg_Date { get; set; }

        public int Invoice_Cov_Letter { get; set; }
        public int Is_Manual_Num { get; set; }

        //Added by Gomathi on 29/may/2020 for Statewise Billing
        public bool IS_StateWiseBilling { get; set; }
        //
        public string XmlCustEmailDet { get; set; }
        public int BillEmailType { get; set; }
    }
    ...
    public class AccountCreationEntity
    {
        ...
        public DateTime RSCommencedate { get; set; }
        public DateTime RSSigndate { get; set; }
        ...
        //opc042 start
        public string XmlCustEmailDetails { get; set; }
        //opc042 end
        ...
        public decimal dcmAutoRentAmount { get; set; }
        ...
        public string strSA_User_Pin { get; set; }
        ...
        public decimal dcmReset_Amount { get; set; }
        public string XMLReWriteAmount { get; set; }
        public string XMLRWInvoiceAmount { get; set; }
        //Added by saran on 4-Jul-2014 for CR_SISSL12E046_018 end

        //Added by Jeyagomathi M on 9-Jul-2014 for Home loan start
        public string @XML_AssetLoanDetails { get; set; }

        //Added by Jeyagomathi M on 9-Jul-2014 for Home loan end

        //Added by saran on 15-Oct-2014 for OPC start
        public int Billing_Address { get; set; }
        public int Cust_Address_ID { get; set; }
        public int Acc_Mngr1 { get; set; }
        public int Acc_Mngr2 { get; set; }
        public int Delivery_State { get; set; }
        public int Billing_State { get; set; }
        public int Proposal_Type { get; set; }
        public int Adv_Rent_Sec_Dep { get; set; }
        public int Secu_Deposit_Type { get; set; }
        public decimal AR_SD_Amount { get; set; }
        public int ReturnPattern { get; set; }
        public int Seco_Term_Applicability { get; set; }
        public decimal One_Time_Fee { get; set; }
        public int Repayment_Mode { get; set; }
        public decimal Processing_Fee_Per { get; set; }
        public int VAT_Rebate_Applicability { get; set; }
        public string Remarks { get; set; }
        public int RS_type { get; set; }
        public string Cform_Number { get; set; }
        public string SEZ_Zone { get; set; }
        public decimal Interim_Rent { get; set; }
        public int Interim_Rent_Days { get; set; }
        public string Interim_Rent_BillRef { get; set; }
        public int Tranch_Header_ID { get; set; }
        public string XMLInvoicesACAT { get; set; }
        public string XMLInvoicesACATSummary { get; set; }
        public string XMLTaxdetails { get; set; }
        public int Sec_Tenure { get; set; }
        public int ITC_Req { get; set; }
        public int SEZA1 { get; set; }
        public int WithIGST { get; set; }
        public int AMF_Sold { get; set; }
        public int VAT_Sold { get; set; }
        public int ServiceTax_Sold { get; set; }
        //Added by saran on 15-Oct-2014 for OPC start
        ...
        public int Is_StdFreq_Applicable { get; set; }//Added by vinodha m for the Call Ref ID 3663 on 20 May,2016
        public int Is_StdFreq_Applicable_Sec { get; set; }//Added by Chandru K for the Call Ref ID 4154 on  11 July,2016
        public int Is_FullRental { get; set; }//Added by Chandru K for the Call Ref ID 12219 on 12 July,2018
        public int CST_Deal { get; set; }//Added by Chandru K for the Call Ref ID 4203 on 11 July,2016
        public int VAT_Leasing { get; set; }//Added by Gomathi M for the Call Ref ID 5093 
        public int IsSep_Amort { get; set; }//Added by Chandru K for the Call Ref ID 4154, CR_56 on  06 Feb, 2017
        public int intLien_Reference_ID { get; set; }
        public string GSTIN { get; set; }
        public string Lable { get; set; }
        public string Address { get; set; }

        public string Rental_TDS_Sec { get; set; }
    }
    ...
    public class BillingEntity
    {
        ...
        public int intLobId { get; set; }
        public int intBranchId { get; set; }
        public int intBillingId { get; set; }
        ...
        public int intCustomer_ID { get; set; }   //Added On 07-Sep-2016
        public string strXmlAccDetails { get; set; }
        public int intInvoiceType { get; set; }
        public string strXmlCustomerDetails { get; set; }

        public string strGroupName { get; set; }
        public int strCustomer_ID { get; set; }
        public int intBilling_ID { get; set; }
        public string XMLGroupRSDetails { get; set; }
        public string strEmailTo { get; set; }
        public string strEmailCC { get; set; }
...
namespace S3GBusEntity.ApplicationProcess
{
    ...
    public class ApplicationProcess
    {
        ...
        public string XML_AssetLoanDet { get; set; }
        public string XML_AssetLoanHDR { get; set; }
        public string XML_AssetLoandoc { get; set; }
